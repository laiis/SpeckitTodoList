...
- [ ] T005 [P] 實作密碼加密與比對工具函數於 `server/utils/auth.js` (bcrypt)
- [ ] T006 實作 JWT 簽發與驗證服務於 `server/services/tokenService.js` (24h 有效期)
- [ ] T007 [P] 建立身份驗證中間件 `server/middleware/auth.js` (驗證 JWT & HttpOnly Cookie)
- [ ] T008 建立角色權限檢查中間件 `server/middleware/rbac.js`
- [ ] T009 [P] 為中間件撰寫單元測試以確保安全攔截邏輯正確 (C2)
...
- [ ] T016 [US1] 建立前端登入頁面 `public/pages/login.html`
...
- [ ] T021 [US3] 建立前端註冊頁面 `public/pages/register.html`
...
- [ ] T025 [US2] 應用 RBAC 中間件於 Task 路由，限制 Viewer 僅能讀取 (FR-006)
...
- [ ] T031 建立管理員儀表板頁面 `public/pages/admin.html`，展示使用者清單與日誌
